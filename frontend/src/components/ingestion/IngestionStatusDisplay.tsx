      ...
      <div className="relative z-10 text-center px-8 py-10" style={{
        ...
        <div className="flex items-center justify-center space-x-3">
          {onRetry && (
            <button
              onClick={onRetry}
              className="inline-flex items-center px-6 py-3 bg-white text-black rounded-full hover:bg-gray-200 transition-all font-mono font-medium shadow-lg hover:shadow-xl text-sm"
            >
              Try Again
            </button>
          )}
          <button
            onClick={() => navigate('/')}
            className="inline-flex items-center px-6 py-3 bg-gray-800 text-gray-200 rounded-full hover:bg-gray-700 transition-all font-mono font-medium text-sm"
          >
            Back to Home
          </button>
        </div>
