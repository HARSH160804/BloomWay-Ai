# BloomWay AI - Deployment Summary
...
All references to `bloomway-ai` have been replaced with the actual deployed stack name `h2s-backend`:
...
✅ **CloudFormation Stack:** `h2s-backend` (not `bloomway-ai`)  
...
**Issue:** "Stack bloomway-ai does not exist"  
