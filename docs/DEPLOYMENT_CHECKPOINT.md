...
The BloomWay AI backend has been successfully deployed to AWS using SAM.
...
1. **Stack Name Mismatch:**
   - Documentation originally referenced: `bloomway-ai`
...
**Symptom:** Scripts reference `bloomway-ai` but stack is `h2s-backend`
